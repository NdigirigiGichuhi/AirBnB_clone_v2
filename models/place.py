...
class Place(BaseModel, Base):
    ...
    if getenv("HBNB_TYPE_STORAGE") == "db":
        ...
        def amenities(self):
            ...
            amenity_ids that contains all the Amenity.id linked to the
            place
            """
            from models import storage
        ...
        def amenities(self, obj):
            """Setter attribute amenities that handles the append method
            for adding Amenity.id to the attribute amenity_ids
            """
